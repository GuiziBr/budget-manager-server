...
-- CreateIndex
CREATE UNIQUE INDEX "budget_periods_year_month_key" ON "budget_periods"("year", "month");

-- CreateIndex
CREATE UNIQUE INDEX "budget_envelopes_budget_period_id_category_id_key" ON "budget_envelopes"("budget_period_id", "category_id");
